...
public:
    ...
    // Important: if defined, the copy constructor needs to explicitly call the copy constructors of A and B
    ...
    C& operator=(const C& other) {
        // Important: if defined, the assignment operator= of C needs to explicitly call the operator= of A and B
        // if we don't explicitly call them in the body of the operator=,
        // it won't do anything to the members a and b, which is NOT what we want in most cases!!!
